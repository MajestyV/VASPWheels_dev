...
################################################################################################################
# 第一性原理计算结果的存放目录
# data_directory = 'D:/Projects/PhaseTransistor/Data/Simulation/Conductivity/Orthogonal_supercell/4/'  # 办公室电脑
data_directory = 'D:/PhD_research/Data/Simulation/MoS2/CarrierTransport/4/Ort_supercell/Ebands/2H_quadrilayer_ManualOptimized/'
...
VB.Electron_bands(Kpath_projected,bands_shifted,Knodes_projected,ylim=(-2,4.5),HighSymPoint=HighSymPoint_dict['ORT_2'])