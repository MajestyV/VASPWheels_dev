...
Main_directory = 'D:/Projects/PhaseTransistor/Data/Simulation/GSE/1/1_D3BJ_GSE_m1_221013/'

# 在不同层数的计算结果的文件夹中，存放数据的文件夹；同时也恰好时电场强度，单位为V/Angstrom
Efield = ['m0.550','m0.525','m0.500','m0.475','m0.450','m0.425','m0.400','m0.375','m0.350','m0.325','m0.300','m0.275',
          'm0.250','m0.225','m0.200','m0.175','m0.150','m0.125','m0.100','m0.075','m0.050','m0.025']
#Efield = ['0.000','0.025','0.050','0.075','0.100','0.125','0.150','0.175','0.200','0.225','0.250','0.275','0.300',
          #'0.325','0.350','0.375','0.400','0.425','0.450','0.475','0.500','0.525','0.550']

Bandgap, ValenceMax, ConductionMin, Extremum_POS = [[],[],[],[]]
for n in Efield:
    data_directory = Main_directory+'/'+n+'/'  # 存放画能带图所需的数据文件的绝对地址
