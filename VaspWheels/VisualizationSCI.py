...
class plot:
    ...
    def GlobalSetting(self,**kwargs):
        ...
        figsize = kwargs['figsize'] if 'figsize' in kwargs else (32.0/15.0,1.6)
    ...
    def Visualize(self,x,y,**kwargs):
        ...
        linewidth = kwargs['linewidth'] if 'linewidth' in kwargs else 0.75  # 控制线宽的参数
    ...
    def FigureSetting(self,**kwargs):
        ...
        legend_size = kwargs['legend_size'] if 'legend_size' in kwargs else fontsize  # 控制图例大小的参数
        if legend == 'True':
        ...
        # 控制x轴跟y轴坐标轴名称的模块
        label_size = kwargs['label_size'] if 'label_size' in kwargs else fontsize  # 控制坐标轴名称大小的参数
        if 'xlabel' in kwargs:
        ...
        # 控制x轴跟y轴刻度大小的模块
        tick_size = kwargs['tick_size'] if 'tick_size' in kwargs else fontsize  # 控制x轴跟y轴刻度大小的参数
        ...
        # 控制图标题的模块
        if 'title' in kwargs:
            plt.title(kwargs['title'],size=fontsize)
        else:
            pass
